#!/usr/bin/env python3
"""F1 primary causality evaluation plus forced-gate diagnostics.
...
GROUP_SPECS = {
    "F1-C0": {"dataset": "C0-N", "aux_mode": "zero", "gate_mode": "learned"},
    "F1-I-fixed": {"dataset": "C1-I", "aux_mode": "ir", "gate_mode": "fixed_one"},
    "F1-I-soft": {"dataset": "C1-I", "aux_mode": "ir", "gate_mode": "learned"},
}
...
def main() -> None:
    ...
    out = run_dir / "eval_step4_f1_causality.json"
    if out.exists() and not a.overwrite:
        raise RuntimeError(f"REFUSE_OVERWRITE_F1_CAUSALITY_EVAL: {out}")
    ...
    result = {
        "schema": "step4-f1-stock-validator-semantics-v1",
        "group": a.group,
        "aux_mode": spec["aux_mode"],
        "gate_mode": spec["gate_mode"],
