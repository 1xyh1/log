...
GROUP_SPECS = {
    "B1-C0": {"dataset": "C0-N", "aux_mode": "zero", "gate_mode": "learned"},
    "B1-I-fixed": {"dataset": "C1-I", "aux_mode": "ir", "gate_mode": "fixed_one"},
    "B1-I-soft": {"dataset": "C1-I", "aux_mode": "ir", "gate_mode": "learned"},
}
...
def main() -> None:
    ...
    out = run_dir / "eval_step4_f1_b_causality.json"
    if out.exists() and not a.overwrite:
        raise RuntimeError(f"REFUSE_OVERWRITE_B1_CAUSALITY_EVAL: {out}")
    ...
    result = {
        "schema": "step4-f1-b-stock-validator-semantics-v1",
        "group": a.group,
        "aux_mode": spec["aux_mode"],
        "gate_mode": spec["gate_mode"],
