...
def main() -> None:
    ...
    if getattr(soft_model, "gate_mode", None) != "learned":
        raise RuntimeError("posthoc gate checks require B1-I-soft learned gate")
    ...
    report = {
        "schema": "step4-f1-b-posthoc-gradient-audit-v1",
        "checks": {
    ...
    out_dir = ROOT / "reports" / "step4_f1_ir_gate"
    out_dir.mkdir(parents=True, exist_ok=True)
    out = out_dir / "posthoc_gradient_audit_b.json"
